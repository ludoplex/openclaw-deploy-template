    ...
    <Panel>
        <template #title>
            <div class="flex items-center">
                <span class="mr-xs"><YouTubeIcon class="text-[#FF0000]"/></span>
                <span>YouTube</span>
            </div>
        </template>
        ...
        <template #description>
            <a href="https://console.cloud.google.com/" class="link" target="_blank">
                Create OAuth credentials in Google Cloud Console</a>.
        ...
        <HorizontalGroup class="mt-lg">
            <template #title>
                <label for="youtube_client_id">Client ID <LabelSuffix danger>*</LabelSuffix></label>
            </template>
        ...
        <HorizontalGroup class="mt-lg">
            <template #title>
                <label for="youtube_client_secret">Client Secret <LabelSuffix danger>*</LabelSuffix></label>
            </template>
        ...
        <HorizontalGroup class="mt-lg">
            ...
            <Flex :responsive="false" class="items-center">
                <Checkbox v-model:checked="form.active" id="youtube_active"/>
                <Label for="youtube_active" class="mb-0!">Active</Label>
            </Flex>
